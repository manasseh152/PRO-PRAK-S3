        ...
        <li>
          <a href="#" onclick="OpenAcount()">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M14.25 5.25V8.25H4.3725L7.0575 5.5575L6 4.5L1.5 9L6 13.5L7.0575 12.4425L4.3725 9.75H15.75V5.25H14.25Z" />
            </svg>
            Back
          </a>
        </li>
